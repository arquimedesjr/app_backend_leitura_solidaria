...
public class OngsController {
    ...
    public Object insert(@Valid @RequestBody OngsRequest obj) {

        OngsResponse users = service.insert(obj, mapper);
    ...
    public void update(@Valid @RequestBody OngsRequest obj, @PathVariable Integer id) {
