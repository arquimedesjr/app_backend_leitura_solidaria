...
public class UsersServiceTest {
    ...
    @BeforeEach
    public void setUp() {
        service = new UsersServiceImpl(usersRepository, organizationRepository, profileRepository);
    ...
    public void deveRetornarTodosUsuario() throws Exception {
        ...
        var jsonExpect = "[{\"id\":4,\"name\":\"Arquimedes Junior\",\"mail\":\"main@junior.com\",\"url_image\":\"https:/teste.imagem.com\",\"profiles\":{\"id\":1,\"type\":\"ONG\"},\"ong\":{\"id\":3,\"name\":\"Todos Pela Saude LTDA\"},\"partner\":null},{\"id\":5,\"name\":\"João Batista\",\"mail\":\"main@josdaqao.com\",\"url_image\":\"https:/teste.imagem.com\",\"profiles\":{\"id\":1,\"type\":\"ONG\"},\"ong\":{\"id\":3,\"name\":\"Todos Pela Saude LTDA\"},\"partner\":null}]";
    ...
    public void deveRetornarUmUsuario() throws Exception {
        ...
        Users users = service.find(1, mapper);

        String json = new ObjectMapper().writeValueAsString(users);

        var jsonExpect = "{\"id\":1,\"name\":\"Arquimedes Junior\",\"mail\":\"main@junior.com\",\"url_image\":\"https:/teste.imagem.com\",\"profiles\":{\"id\":1,\"type\":\"ONG\"},\"ong\":{\"id\":1,\"name\":\"Todos Pela Saude LTDA\"},\"partner\":null}";
